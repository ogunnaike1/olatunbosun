 ...
 *
 * Shared by the home section and the FAQ page, which is why it takes its
 * questions as a prop and renders no heading of its own.
 */
          ...
          >
            <dt className="m-0">
              ...
              >
                ...
                {/* A plus that rotates into a cross — the only motion the
                    control needs. */}
                <span
                  aria-hidden="true"
